...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(name, category, price, image,view) VALUES(?,?,?,?,?)");
         $insert_product->execute([$name, $category, $price, $image,$view]);
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex">
         ...
         <div class="category"><?= $fetch_products['view']; ?></div>
      </div>
